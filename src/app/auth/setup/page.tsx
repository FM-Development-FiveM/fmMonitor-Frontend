...
export default function Page() {
    ...
    const [getRepeatPasswordField, setRepeatPasswordField] = React.useState("");
    ...
    const createAdminUser = () => {
        console.log(`Username: ${getUsernameField} | Password: ${getPasswordField} | Repeat Password: ${getRepeatPasswordField}`);
    }
    ...
    return (
        <main className="fmScreen fmCenterScreen fmFirstSetupScreen">
            <div className="fmCenterContent">
                ...
                <span className="fmCenterContentSubtitleSm">In order to start using fmMonitor, You will need to setup an admin account!</span><br></br>
                ...
                <div className="fmCenterLoginForm">
                    ...
                    <div style={{ display: "flex", flexDirection: "row" }}>
                        <Form.Input required={true} onChange={(e) => setPasswordField(e.target.value)}  width="450px" backgroundColor="rgba(217, 217, 217, 30%)" style={{ outline: "3px solid rgba(255, 255, 255, 0.44)", border: "none" }} type="password" autoComplete="new-password" spellCheck="false" id="fmPasswordInput" name="fmPasswordInput" />
                    </div>
                    <br></br>
                    <Form.Label mb="5px" fontSize="18px" htmlFor="fmRepeatPasswordInput">Repeat Password</Form.Label>
                    <div style={{ display: "flex", flexDirection: "row" }}>
                        <Form.Input required={true} onChange={(e) => setRepeatPasswordField(e.target.value)}  width="450px" backgroundColor="rgba(217, 217, 217, 30%)" style={{ outline: "3px solid rgba(255, 255, 255, 0.44)", border: "none" }} type={getPasswordType} autoComplete="new-password" spellCheck="false" id="fmRepeatPasswordInput" name="fmRepeatPasswordInput" />
                    ...
                    <br></br>
                    <Rebass.Button type="submit" onClick={createAdminUser} mb="15px" fontSize="20px" style={{ border: "3px solid rgba(255, 255, 255, 0.45)" }} backgroundColor="rgba(183, 181, 166, 3%)" width="100%">Create Admin Account</Rebass.Button>
                    <br></br>
